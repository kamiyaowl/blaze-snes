...
dotnet test --collect:"XPlat Code Coverage" --logger "junit;LogFileName=unittest.result.xml"
...
mkdir -p ./unittest
junit2html BlazeSnes.test/unittest.result.xml ./unittest/blazesnes.html
junit2html BlazeSnes.Core.test/unittest.result.xml ./unittest/blazesnes.core.html
